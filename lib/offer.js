...
module.exports = class Offer extends AbstractOffer {
  ...
  async init() {
    ...
    this.from = new this._libbarter._LimitedUser(offerObject.from_user_id, offerObject.from_username, this._libbarter, { steamid: offerObject.from_steamid, role: "from" });

    if (offerObject.to_user_id !== "ffffffffffffffff") {
      this.to = new this._libbarter._LimitedUser(offerObject.to_user_id, offerObject.to_username, this._libbarter, { steamid: offerObject.to_steamid, role: "from" });
    }
    else {
